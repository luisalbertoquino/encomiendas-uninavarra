...
<section class="panel">
    ...
    <p class="lede">Administra las dependencias de destino y su correo institucional, para que administrativa lo autocomplete al reasignar.</p>
    ...
    <div class="card pad">
        ...
        <div class="result-head" style="padding:10px 0;border-bottom:1px solid var(--border)">
            <div>
                ...
                <div style="font-size:12.5px;color:var(--muted)">{{ $d->correo ?: 'Sin correo asignado' }}</div>
            </div>
